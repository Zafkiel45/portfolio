...
export function HeaderSection() {
  ...
  return (
    <nav className={`w-fit h-fit lg:px-3 px-2 py-1 lg:py-2 rounded-xl flex items-center transition-transform gap-2 ${isScroll ? 'bg-[#0d0d0d] scale-105 border border-[#525252] shadow-md shadow-[#a2ff006b]':'scale-100'}`}>
